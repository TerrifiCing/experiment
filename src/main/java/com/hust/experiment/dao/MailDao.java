...
public interface MailDao {
    ...
    String SELECT_FIELDS = " id, from_id, to_id, type, content, time, title";
    String INSERT_FIELDS = " from_id, to_id, type, content, time, title";

    @Insert({"insert into ",TABLE_NAME,"(",INSERT_FIELDS ,") values (#{fromId},#{toId},#{type},#{content},#{time},#{title})"})
